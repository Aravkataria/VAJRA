...
<head>
  ...
  <style>
    ...
    :root[data-theme="dark"] {
      ...
      --accent: #f5b400;
      --accent-hover: #ffc72c;
      --accent-glow: rgba(245, 180, 0, 0.15);
    ...
    :root[data-theme="light"] {
      ...
      --stamp-pass: #16a34a;
      --stamp-pass-bg: rgba(22, 163, 74, 0.1);
      --stamp-pass-border: rgba(22, 163, 74, 0.3);
      ...
      --stamp-warn: #b45309;
      --stamp-warn-bg: rgba(180, 83, 9, 0.1);
      --stamp-warn-border: rgba(180, 83, 9, 0.3);
